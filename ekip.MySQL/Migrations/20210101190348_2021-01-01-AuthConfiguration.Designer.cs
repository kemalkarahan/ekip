...
namespace ekip.MySQL.Migrations
{
    ...
    [Migration("20210101190348_2021-01-01-AuthConfiguration")]
    partial class _20210101AuthConfiguration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ekip.Core.Entities.Concrete.OperationClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ekip.Core.Entities.Concrete.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ekip.Core.Entities.Concrete.UserOperationClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ekip.Entities.Concrete.Staff", b =>
                {
                    b.HasBaseType("ekip.Core.Entities.Concrete.User");
            ...
            modelBuilder.Entity("ekip.Core.Entities.Concrete.UserOperationClaim", b =>
                {
                    b.HasOne("ekip.Core.Entities.Concrete.OperationClaim", "OperationClaim")
                        .WithMany()
                        .HasForeignKey("OperationClaimId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ekip.Core.Entities.Concrete.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("ekip.Entities.Concrete.Participant", b =>
                {
                    b.HasOne("ekip.Core.Entities.Concrete.User", "Attendee")
                        .WithMany()
